...
import graduationImg from "@/assets/images/academy/cta/graduation.jpg";
  ...
  return (
    <section className="px-6 md:px-20 pb-24">
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative max-w-6xl mx-auto overflow-hidden bg-gradient-to-br from-primary via-primary-dark to-primary-darker rounded-3xl p-10 md:p-16 text-center"
      >
        <GridOverlay opacity={0.03} size={50} color="rgba(255,255,255,0.06)" />
        <FloatingOrbs
          orbs={[
            { size: 400, color: "bg-accent", x: 70, y: 30, duration: 20, delay: 0, blur: 130 },
            { size: 300, color: "bg-secondary", x: 20, y: 60, duration: 22, delay: 1, blur: 100 },
          ]}
        />
        <div className="relative z-10">
          <div className="w-16 h-16 rounded-full bg-white/10 flex items-center justify-center text-white mx-auto mb-6 overflow-hidden ring-2 ring-white/30">
            <Image
              src={graduationImg}
              alt="Graduation"
              width={64}
