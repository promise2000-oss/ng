...
const storyParagraphs = [
  "NICEGENE Technologies is a premiere IT Consulting & Digital Solutions firm based in Lagos Nigeria, built to close the gap between traditional, manual operations and modern digital efficiency. We provide end-to-end technology integration for schools, businesses, and public institutions, delivered through a focused portfolio of cloud, infrastructure, development, and training services.",
