...
export default function ProjectsFilterBar({
  ...
  searchQuery: string;
  onCategoryChange: (c: ProjectCategory) => void;
    ...
    >
      ...
      >
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 rounded-full bg-surface border border-gray-200 text-sm text-text-primary placeholder:text-text-primary/70 focus:outline-none focus:border-purple-500/40 focus:bg-surface/80 transition-all"
        />
      </motion.div>
    </motion.div>
  );
