...
import partnersImg from "@/assets/images/services/AWS Cloud.png";
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 py-24 md:py-32">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white max-w-3xl leading-tight">
            Strong Partnerships. <span className="text-accent-light">Trusted Technology.</span>
          </h1>
          <p className="text-white/70 mt-5 max-w-2xl text-sm md:text-base leading-relaxed">
            NICEGENE Technologies works with leading technology platforms, academic institutions,
            and business allies to deliver end-to-end digital transformation — backed by
            enterprise-grade infrastructure, not proprietary black boxes.
          </p>
        </motion.div>
      </div>
    </section>
